...
class PostsNew extends Component {
  ...
  render() {
    ...
    // ES6 syntax. It's like:
    // const handleSubmit = this.props.handleSubmit;
    const { fields: { title, categories, content} } = this.props;
    // idem, like:  const title = this.props.fields.title for example
    ...
    return (
      <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
        ...
        <div className={`form-group ${title.touched && title.invalid ? 'has-danger' : ''}`}>
          <label>Title</label>
          {
            // destructuring the object into separate keys and values and
...
export default reduxForm(reduxFormConfiguration, null, { createPost })(PostsNew);
